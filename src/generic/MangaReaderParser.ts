...
import { MangaReaderGeneric } from "./MangaReader";
import {
    MangaReaderDiscoverSection,
    MangaReaderSearchResultItem,
} from "./MangaReaderInterfaces";
import { getUsePostIds } from "./MangaReaderSettingsForm";
import { convertDate } from "./MangaReaderUtils";

export class MangaReaderParser {
    parseMangaDetails(
        $: CheerioAPI,
        mangaId: string,
        source: MangaReaderGeneric,
    ): SourceManga {
        const titles: string[] = [];
    ...
    parseSearchResults($: CheerioAPI): MangaReaderSearchResultItem[] {
        const results: MangaReaderSearchResultItem[] = [];
    ...
    async parseHomeSection(
        $: CheerioAPI,
        section: MangaReaderDiscoverSection,
        source: MangaReaderGeneric,
